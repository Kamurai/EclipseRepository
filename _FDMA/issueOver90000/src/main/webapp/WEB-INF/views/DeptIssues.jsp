...
<html>
	...
	<head>
		<title>Department Admin Issues</title>
	...
	<body>
		...
		<%ArrayList<Issue> list=(ArrayList<Issue>)request.getAttribute("deptIssueList");%>
		...
		<div id="navbar">
			...
			<div id="navtab">
				<a id="navbutton1" href="<%=request.getContextPath()%>/deptissues">Department admin Issues</a>
			</div>
			
			<div id="navtab">
				<a id="navbutton" href="<%=request.getContextPath()%>/genissues">General admin Issues</a>
			</div>
		</div>
		...
		<div id="tableBorder">
			<Table>
				...
				<tr>
					...
					<td><a id="lostPassword" href="<%=request.getContextPath()%>/deptissueupdate?issueId=<%=issueList.getIssueId()%>">Update</a></td>
				</tr>
				<%} %>
			</Table>
