...
public class Highlighter2 
{
	...
	public static Highlighter highlighter = new Hmarker(null);
	
	public Highlighter2(JTextPane textPane, JTextPane output) 
	{
...
/*	
		...
		try 
		{
			textPane.read(new FileReader("C:\\Users\\christopher.kemerait\\Documents\\Workspace\\USANIDE\\src\\highlightExample\\links1.html"), null);
		}
		catch (Exception e) 
		{
...
class WordSearcher 
{
	...
	{
		this.comp = comp;
		this.painter = new Hmarker.Underliner(Color.red);
	}
	...
	public int search(String word) 
	{
		...
		for (int i = 0; i < highlights.length; i++) 
		{
			...
			if (h.getPainter() instanceof Hmarker.Underliner) 
			{
