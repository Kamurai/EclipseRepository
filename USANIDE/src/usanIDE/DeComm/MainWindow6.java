...
public class MainWindow6 extends JFrame 
{
	...
	public MainWindow6() 
	{
		...
		mainBox.getDocument().addDocumentListener(new SigmaListener());
		...
		outLabel.setText("This is where the input goes.");
	...
	private class ButtonListener implements ActionListener 
	{
		...
		public void actionPerformed(ActionEvent e) 
		{
			mainBox.setText(controller.getColorNow());
		}
