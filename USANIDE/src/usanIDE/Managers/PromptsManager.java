									...
									if((content.charAt(tracker+1) == 'r'))
									{
										if(tracker < content.length()-1) //not on last character in file
										{
											if((content.charAt(tracker+2) == '_'))
											{
												...
												else if(Sandslash.PromptVariableIsDuplicate(potentialWord, CurrentSection, startofVariableIndex, endofVariableIndex, content))
												{
													errorFound = true;
												...
												else if(BuildingDuplicatePromptSection)
												{
													...
													if(!Sandslash.PromptVariableIsDuplicate(potentialWord, Sandslash.FindBaseSection(CurrentSection, PromptSectionsList), startofVariableIndex, endofVariableIndex, content))
													{
														errorFound = true;
												...
												else if(!Sandslash.PromptVariableHasAlternate(potentialWord, PromptSectionsList, CurrentSection, startofVariableIndex, endofVariableIndex, content))
												{
													errorFound = true;
												...
												else if(!Sandslash.PromptVariableInCode(potentialWord,content))
												{
													errorFound = true;
