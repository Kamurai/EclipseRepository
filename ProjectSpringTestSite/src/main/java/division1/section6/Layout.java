...
public class Layout extends main.Layout
{
    ...
    public String Navigation(int vLevel)
    {
        ...
        vResult += "<a class=\"navlinkA\" href='"+vUniversal.GetPath(vLevel)+"Division1/Section6/Index'>Databases</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Division1/Section6/Project1'>Oracle</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Division1/Section6/Project2'>Derby</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Division1/Section6/Project3'>MySQL</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Division1/Section6/Project4'>SQL Server</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Division1/Section6/Project5'>Postgres</a><br/><br/>";
