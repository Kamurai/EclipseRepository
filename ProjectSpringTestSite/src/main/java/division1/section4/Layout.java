...
public class Layout extends main.Layout
{
    ...
    public String Navigation(int vLevel)
    {
        ...
        vResult += "<a class=\"navlinkA\" href='"+vUniversal.GetPath(vLevel)+"Division1/Section4/Index'>Java</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Division1/Section4/Index'>JSP Spring MVC</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='http://htkb.dyndns.org:8080/JSPApplication/Division1/Section4/Index.jsp'>JSF</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='http://htkb.dyndns.org:8080/JSFApplication/Division1/Section4/Index.xhtml'>JSF</a><br/><br/>";
