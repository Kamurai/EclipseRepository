...
public class Layout extends main.Layout
{
    ...
    private String getNavigation(int vLevel)
    {
        ...
        vResult += "<a class=\"navlinkA\" href='"+vUniversal.getPath(vLevel)+"Division1/Section1/Index'>Databases</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.getPath(vLevel)+"Division1/Section1/Project1'>Oracle</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.getPath(vLevel)+"Division1/Section1/Project2'>Derby</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.getPath(vLevel)+"Division1/Section1/Project3'>MySQL</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.getPath(vLevel)+"Division1/Section1/Project4'>SQL Server</a><br/><br/>";
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.getPath(vLevel)+"Division1/Section1/Project5'>Postgres</a><br/><br/>";
