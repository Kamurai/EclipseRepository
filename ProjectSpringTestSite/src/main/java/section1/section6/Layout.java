...
public class Layout extends main.Layout
{
    ...
    public String Navigation(int vLevel)
    {
        ...
        Result += "<a class=\"navlinkA\" href='"+vUniversal.GetPath(vLevel)+"Section1/Section6/Index'>Databases</a><br/><br/>";
            Result += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Section1/Section6/Project1'>Oracle</a><br/><br/>";
            Result += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Section1/Section6/Project2'>Derby</a><br/><br/>";
            Result += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Section1/Section6/Project3'>MySQL</a><br/><br/>";
            Result += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Section1/Section6/Project4'>SQL Server</a><br/><br/>";
            Result += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Section1/Section6/Project5'>Postgres</a><br/><br/>";
