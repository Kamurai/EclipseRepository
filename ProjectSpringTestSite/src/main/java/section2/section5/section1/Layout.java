    ...
    public String Navigation(int vLevel)
    {
        ...
        Result += "<a class=\"navlinkA\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section5/Index'>Antarrea</a><br/><br/>";
            Result += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section5/Section1/Index'>Global</a><br/><br/>";
                Result += "<a class=\"navlinkC\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section5/Section1/Project1'>Team Tactial: Crash Ball</a><br/><br/>";
                Result += "<a class=\"navlinkC\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section5/Section1/Project2'>Wars of Antarrea</a><br/><br/>";
                Result += "<a class=\"navlinkC\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section5/Section1/Project3'>Revolutions: Invading Nations</a><br/><br/>";
                Result += "<a class=\"navlinkC\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section5/Section1/Project4'>Revolutions: Rebellion Against the Fist</a><br/><br/>";
                Result += "<a class=\"navlinkC\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section5/Section1/Project5'>Revolutions: Return to Arms</a><br/><br/>";
                Result += "<a class=\"navlinkC\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section5/Section1/Project6'>Revolutions: Post Wars</a><br/><br/>";
