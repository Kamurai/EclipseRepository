...
public class Layout extends main.Layout
{
    ...
    {
        String Result = "";
        Result += "<a class=\"navlinkA\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section1/Section2/Section4/Index'>Gynowars</a><br/><br/>";
        ...
        Result += "<a class=\"navlinkA\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section4/Section2/Section4/Index'>Renley</a><br/><br/>";
            Result += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section4/Project1.html'>Warring Nations</a><br/><br/>";
            Result += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section4/Project2.html'>Psychodom: The One Empire</a><br/><br/>";
        Result += "<a class=\"navlinkA\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section5/Section2/Section4/Index'>Antarrea</a><br/><br/>";
