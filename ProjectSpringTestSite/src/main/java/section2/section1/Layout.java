...
public class Layout extends main.Layout
{
    ...
    {
        String Result = "";
        Result += "<a class=\"navlinkA\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section1/Section2/Section1/Project1'>Gynowars</a><br/><br/>";
            Result += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section1/Project1.html'>Gynowars RPG</a><br/><br/>";
            Result += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section1/Project2.html'>Gynowars: Battle Arena CCG</a><br/><br/>";
            Result += "<a class=\"navlinkB\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section1/Project3.html'>Gynowars: Crash Ball</a><br/><br/>";
        ...
        Result += "<a class=\"navlinkA\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section4/Section2/Section1/Project1'>Renley</a><br/><br/>";
        Result += "<a class=\"navlinkA\" href='"+vUniversal.GetPath(vLevel)+"Section2/Section5/Section2/Section1/Project1'>Antarrea</a><br/><br/>";
