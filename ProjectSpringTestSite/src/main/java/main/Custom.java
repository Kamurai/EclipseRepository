            ...
            else if(vPage == 3)
            {
                    ...
                    Result += "Creative Server:     (1.7.10) htkb.dyndns.org:25567</br>";
                        Result += "This is a list of mods that we are using on the server, compatible with 1.7.10.</br>";
                            ...
                            Result += "<a href='./Downloads/Minecraft/[1.7.10]Treecapitator-vUniversal-2.0.4.jar'>Tree Capitator</a></br>";
                    ...
                    Result += "Here is a skin template to make vCustom skins:</br>";
