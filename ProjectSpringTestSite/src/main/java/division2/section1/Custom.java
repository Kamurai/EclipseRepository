...
public class Custom extends division2.Custom
{
    ...
    public String getVersions(int vPage)
    {
		...
		vDefault += "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division2/Section1/Index\">JSP Spring MVC</a><br/>";
		vDefault += "<a href=\"http://htkb.dyndns.org:81/ASP/Division2/Section1/Index.asp\">ASP Javascript</a><br/>";
        ...
        else if(vPage == 1)
        {
    		...
    		vResult += "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division2/Section1/Project1\">JSP Spring MVC</a><br/>";
    		vResult += "<a href=\"http://htkb.dyndns.org:81/ASP/Division2/Section1/Project1.asp\">ASP Javascript</a><br/>";
        ...
        else if(vPage == 2)
        {
    		...
    		vResult += "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division2/Section1/Project2\">JSP Spring MVC</a><br/>";
    		vResult += "<a href=\"http://htkb.dyndns.org:81/ASP/Division2/Section1/Project2.asp\">ASP Javascript</a><br/>";
        ...
        else if(vPage == 3)
        {
    		...
    		vResult += "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division2/Section1/Project3\">JSP Spring MVC</a><br/>";
    		vResult += "<a href=\"http://htkb.dyndns.org:81/ASP/Division2/Section1/Project3.asp\">ASP Javascript</a><br/>";
