    ...
    private String getNavigation(int vLevel)
    {
        ...
        vResult += "<a class=\"navlinkA\" href='"+vUniversal.getPath(vLevel)+"Division2/Section5/Index'>Antarrea</a><br/><br/>";
            ...
            vResult += "<a class=\"navlinkB\" href='"+vUniversal.getPath(vLevel)+"Division2/Section5/Section2/Index'>Grendol</a><br/><br/>";
                vResult += "<a class=\"navlinkC\" href='"+vUniversal.getPath(vLevel)+"Division2/Section5/Section2/Project1'>Land of the Orcish Empire: Age of Magic</a><br/><br/>";
                vResult += "<a class=\"navlinkC\" href='"+vUniversal.getPath(vLevel)+"Division2/Section5/Section2/Project2'>Coliseum: Arena</a><br/><br/>";
