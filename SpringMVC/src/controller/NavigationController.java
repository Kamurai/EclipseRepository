...
public class NavigationController {
	...
	public String navigateToDivision1_1Index(HttpServletRequest request, HttpSession session) {
		return "Division1/Section1/Index";
	}

	@RequestMapping(value = "/Division1/Section1/Project1")
	public String navigateToDivision1_1Project1(HttpServletRequest request, HttpSession session) {
		return "Division1/Section1/Project1";
	}

	@RequestMapping(value = "/Division1/Section1/Project2")
	public String navigateToDivision1_1Project2(HttpServletRequest request, HttpSession session) {
		return "Division1/Section1/Project2";
	}

	@RequestMapping(value = "/Division1/Section1/Project3")
	public String navigateToDivision1_1Project3(HttpServletRequest request, HttpSession session) {
		return "Division1/Section1/Project3";
	}

	@RequestMapping(value = "/Division1/Section1/Project4")
	public String navigateToDivision1_1Project4(HttpServletRequest request, HttpSession session) {
		return "Division1/Section1/Project4";
	}

	@RequestMapping(value = "/Division1/Section1/Project5")
	public String navigateToDivision1_1Project5(HttpServletRequest request, HttpSession session) {
	...
	public String navigateToDivision2_1Project3(HttpServletRequest request, HttpSession session) {
	...
	public String navigateToDivision2_4Index(HttpServletRequest request, HttpSession session) {
		return "Division2/Section4/Index";
	}

	@RequestMapping(value = "/Division2/Section4/Project1")
	public String navigateToDivision2_4Project1(HttpServletRequest request, HttpSession session) {
		return "Division2/Section1/Project1";
	}

	@RequestMapping(value = "/Division2/Section4/Project2")
	public String navigateToDivision2_4Project2(HttpServletRequest request, HttpSession session) {
		return "Division2/Section4/Project2";
	}

	@RequestMapping(value = "/Division2/Section5/Index")
	public String navigateToDivision2_5Index(HttpServletRequest request, HttpSession session) {
		return "Division2/Section5/Index";
	}

	@RequestMapping(value = "/Division2/Section5/Section1/Index")
	public String navigateToDivision2_5_1Index(HttpServletRequest request, HttpSession session) {
		return "Division2/Section5/Section1/Index";
	}

	@RequestMapping(value = "/Division2/Section5/Section1/Project1")
	public String navigateToDivision2_5_1Project1(HttpServletRequest request, HttpSession session) {
		return "Division2/Section5/Section1/Project1";
	}

	@RequestMapping(value = "/Division2/Section5/Section1/Project2")
	public String navigateToDivision2_5_1Project2(HttpServletRequest request, HttpSession session) {
		return "Division2/Section5/Section1/Project2";
	}

	@RequestMapping(value = "/Division2/Section5/Section1/Project3")
	public String navigateToDivision2_5_1Project3(HttpServletRequest request, HttpSession session) {
		return "Division2/Section5/Section1/Project3";
	}

	@RequestMapping(value = "/Division2/Section5/Section1/Project4")
	public String navigateToDivision2_5_1Project4(HttpServletRequest request, HttpSession session) {
		return "Division2/Section5/Section1/Project4";
	}

	@RequestMapping(value = "/Division2/Section5/Section1/Project5")
	public String navigateToDivision2_5_1Project5(HttpServletRequest request, HttpSession session) {
		return "Division2/Section5/Section1/Project5";
	}

	@RequestMapping(value = "/Division2/Section5/Section1/Project6")
	public String navigateToDivision2_5_1Project6(HttpServletRequest request, HttpSession session) {
		return "Division2/Section5/Section1/Project6";
	}

	@RequestMapping(value = "/Division2/Section5/Section2/Index")
	public String navigateToDivision2_5_2Index(HttpServletRequest request, HttpSession session) {
		return "Division2/Section5/Section2/Index";
	}

	@RequestMapping(value = "/Division2/Section5/Section2/Project1")
	public String navigateToDivision2_5_2Project1(HttpServletRequest request, HttpSession session) {
		return "Division2/Section5/Section2/Project1";
	}

	@RequestMapping(value = "/Division2/Section5/Section2/Project2")
	public String navigateToDivision2_5_2Project2(HttpServletRequest request, HttpSession session) {
		return "Division2/Section5/Section2/Project2";
	}
	
	@RequestMapping("/Division2/Section5/Section3/Index")
	public String navigateToDivision2_5_3Index(HttpServletRequest request, HttpSession session) {
		return "Division2/Section5/Section3/Index";
	}

	@RequestMapping("/Division2/Section5/Section3/Project1")
	public String navigateToDivision2_5_3Project1(HttpServletRequest request, HttpSession session) {
		return "Division2/Section5/Section3/Project1";
	}

	@RequestMapping(value = "/Division2/Section5/Section4/Index")
	public String navigateToDivision2_5_4Index(HttpServletRequest request, HttpSession session) {
		return "Division2/Section5/Section4/Index";
	}

	@RequestMapping(value = "/Division2/Section5/Section4/Project1")
	public String navigateToDivision2_5_4Project1(HttpServletRequest request, HttpSession session) {
		return "Division2/Section5/Section4/Project1";
	}

	@RequestMapping(value = "/Division2/Project6")
	public String navigateToDivision2Project6(HttpServletRequest request, HttpSession session) {
		return "Division2/Project6";
	}

	@RequestMapping(value = "/Division2/Project7")
	public String navigateToDivision2Project7(HttpServletRequest request, HttpSession session) {
		return "Division2/Project7";
	}

	@RequestMapping(value = "/Division2/Project8")
	public String navigateToDivision2Project8(HttpServletRequest request, HttpSession session) {
		return "Division2/Project8";
	}

	@RequestMapping(value = "/Division2/Project9")
	public String navigateToDivision2Project9(HttpServletRequest request, HttpSession session) {
		return "Division2/Project9";
	}

	@RequestMapping(value = "/Division2/Project10")
	public String navigateToDivision2Project10(HttpServletRequest request, HttpSession session) {
		return "Division2/Project10";
	}

	@RequestMapping(value = "/Division2/Project11")
	public String navigateToDivision2Project11(HttpServletRequest request, HttpSession session) {
		return "Division2/Project11";
	}

	@RequestMapping(value = "/Division2/Project12")
	public String navigateToDivision2Project12(HttpServletRequest request, HttpSession session) {
		return "Division2/Project12";
	}

	@RequestMapping(value = "/Division2/Project13")
	public String navigateToDivision2Project13(HttpServletRequest request, HttpSession session) {
		return "Division2/Project13";
	}

	@RequestMapping(value = "/Division2/Project14")
	public String navigateToDivision2Project14(HttpServletRequest request, HttpSession session) {
