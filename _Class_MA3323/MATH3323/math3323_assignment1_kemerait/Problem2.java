...
public class Problem2 
{
	public static void main(String[] args) 
	{
		...
		{
			expected[x] = 2 * expected[x-1] - expected[x-2];
		}
	...
	public static void displayintroduction() 
	{
		...
		System.out.println(
				...
				"myst(0) = 0\n" +
				"myst(1) = 1\n" +
				"myst(n) = 2 * myst(n-1) - myst(n-2)\n\n"
				);
	}
	
	//calculates the desired values for h(n)
	public static long myst(long n)
	{
		//if n = 0
		if( n == 0 )
		{
	...
	public static void displayresult(long[] first, long[] second) 
	{
		...
		if( flag == true)
		{
			System.out.println("correct.\n\n" +
					"An appropriate formula would seem to be f(x) = x for all x > -1.\n" +
