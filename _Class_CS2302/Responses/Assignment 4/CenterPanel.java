...
/*********************************************
You should have if else logic here since you
do not want to execute the loop if the clear
...
*********************************************/
		...
		/**************************************************
		You would not want to use a for loop here.  You want
		to terminate the loop as soon as you find the button
