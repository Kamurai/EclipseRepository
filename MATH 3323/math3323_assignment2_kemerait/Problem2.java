...
public class Problem2 
{
	public static void main(String[] args) 
	{
		...
		//use iterative procedure to find values
	...
	public static void displayintroduction() 
	{
		...
		System.out.println(
				...
				"Today we are iteration to replace a recursive functions.\n" +
				//display rules for subject matter
				"The rules for this function are as follows:\n\n" +
				"h(0) = 1\n" +
				"h(1) = 0\n" +
				"h(n) = (n-1) * ( h(n-1) + h(n-2) )\n\n" +
				"Please remember, the calculated values will use an iterative process instead.\n\n"
				);
	}
	...
	public static void displayresult(long[] first, long[] second) 
	{
		...
		if( flag == true)
		{
			System.out.println("correct.\n\n" +
					"The iterative process takes x, beginning at 1, multiplies it by an iterating variable, i,\n" +
					"and then alternatingly adds, then substracts 1 to the value, storing the final value at x.\n" +
					"The following iteration of the process using the value stored at x from the previous iteration,\n" +
					"and (as previously stated) the 1 being added is multiplied by -1 .\n" +
