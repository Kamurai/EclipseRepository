...
public class Custom extends division2.section5.Custom
{
    ...
    public String getVersions(int vPage)
    {
		...
		vDefault += "<a href=\"http://htkb.dyndns.org:81/ASP/Division2/Section5/Section3/Index.asp\">ASP Javascript</a><br/>";
		...
		else if(vPage == 1)
		{
			...
			vResult += "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division2/Section5/Section3/Project1\">JSP Spring MVC</a><br/>";
			vResult += "<a href=\"http://htkb.dyndns.org:81/ASP/Division2/Section5/Section3/Project1.asp\">ASP Javascript</a><br/>";
