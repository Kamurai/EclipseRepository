...
public class Custom extends division1.Custom
{
    DerbyMethod dMethod;
    MySQLMethod mMethod;
            ...
            else if(vPage == 4)
            {
                ...
                vResult += "<table>";
                    ...
                    vResult += "<tr>";
                        ...
                        vResult += "</td>";
                        vResult += "<td>";
                            vResult += sMethod.getColorData("SQLSERVER",1);
                        vResult += "</td>";
                    vResult += "</tr>";
                    vResult += "<tr>";
                        vResult += "<td>";
                    ...
                    vResult += "<tr>";
                        vResult += "<td>";
                            vResult += "SQL Server Express Instance";
                        vResult += "</td>";
                        vResult += "<td>";
                            vResult += "";
                        vResult += "</td>";
                    ...
                    vResult += "<tr>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("0",0);
                        vResult += "</td>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("SQLEXPRESS",1);
                        vResult += "</td>";
                    vResult += "</tr>";vResult += "<tr>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("1",0);
                        vResult += "</td>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("Red",1);
                        vResult += "</td>";
                    vResult += "</tr>";
                    vResult += "<tr>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("2",0);
                        vResult += "</td>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("Orange",1);
                        vResult += "</td>";
                    vResult += "</tr>";
                    vResult += "<tr>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("3",0);
                        vResult += "</td>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("Yellow",1);
                        vResult += "</td>";
                    vResult += "</tr>";
                    vResult += "<tr>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("4",0);
                        vResult += "</td>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("Green",1);
                        vResult += "</td>";
                    vResult += "</tr>";
                    vResult += "<tr>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("5",0);
                        vResult += "</td>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("Blue",1);
                        vResult += "</td>";
                    vResult += "</tr>";
                    vResult += "<tr>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("6",0);
                        vResult += "</td>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("Indigo",1);
                        vResult += "</td>";
                    vResult += "</tr>";
                    vResult += "<tr>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("7",0);
                        vResult += "</td>";
                        vResult += "<td>";
                            vResult += eMethod.getColorData("Violet",1);
                        vResult += "</td>";
                    vResult += "</tr>";
    ...
    public String getVersions(int vPage)
    {
		...
		vDefault += "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division1/Section1/Index\">JSP Spring MVC</a><br/>";
		vDefault += "<a href=\"http://htkb.dyndns.org:81/ASP/Division1/Section1/Index.asp\">ASP Javascript</a><br/>";
        ...
        else if(vPage == 1)
        {
    		...
    		vResult += "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division1/Section1/Project1\">JSP Spring MVC</a><br/>";
    		vResult += "<a href=\"http://htkb.dyndns.org:81/ASP/Division1/Section1/Project1.asp\">ASP Javascript</a><br/>";
        ...
        else if(vPage == 2)
        {
    		...
    		vResult += "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division1/Section1/Project2\">JSP Spring MVC</a><br/>";
    		vResult += "<a href=\"http://htkb.dyndns.org:81/ASP/Division1/Section1/Project2.asp\">ASP Javascript</a><br/>";
        ...
        else if(vPage == 3)
        {
    		...
    		vResult += "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division1/Section1/Project3\">JSP Spring MVC</a><br/>";
    		vResult += "<a href=\"http://htkb.dyndns.org:81/ASP/Division1/Section1/Project3.asp\">ASP Javascript</a><br/>";
        ...
        else if(vPage == 4)
        {
    		...
    		vResult += "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division1/Section1/Project4\">JSP Spring MVC</a><br/>";
    		vResult += "<a href=\"http://htkb.dyndns.org:81/ASP/Division1/Section1/Project4.asp\">ASP Javascript</a><br/>";
        ...
        else if(vPage == 5)
        {
    		...
    		vResult += "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division1/Section1/Project5\">JSP Spring MVC</a><br/>";
    		vResult += "<a href=\"http://htkb.dyndns.org:81/ASP/Division1/Section1/Project5.asp\">ASP Javascript</a><br/>";
