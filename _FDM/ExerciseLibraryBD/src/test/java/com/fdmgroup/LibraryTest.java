...
{
	Book testBook = new Book("Test Book", new BigDecimal("5.45"));
	...
	public void test_DoesBasketHaveZeroBalanceWhenZeroBooksAreAdded() 
	{
		...
		assertEquals(0.00, checkOut.calculatePrice(testBasket).doubleValue(), 0);
	}
	...
	public void test_CalculatePrice_ReturnsPriceOfBookInBasket_WhenPassedBasketWithOneBook() 
	{
		...
		assertEquals(testBook.getPrice().doubleValue(), checkOut.calculatePrice(testBasket).doubleValue(), 0);
	}
	...
	public void test_CalculatePrice_ReturnsPriceOfBookInBasket_WhenPassedBasketWithTwoBooks() 
	{
		...
		assertEquals(10.90, checkOut.calculatePrice(testBasket).doubleValue(), 0);
	}
	...
	public void test_CalculatePrice_ReturnsPriceOfBookInBasket_WhenPassedBasketWithThreeBooks() 
	{
		...
		//minus 1%
		assertEquals(16.19, checkOut.calculatePrice(testBasket).doubleValue(), 0);
	}
	...
	public void test_CalculatePrice_ReturnsPriceOfBookInBasket_WhenPassedBasketWithSevenBooks() 
	{
		...
		//minus 2%
		assertEquals(37.39, checkOut.calculatePrice(testBasket).doubleValue(), 0);
	}
	...
	public void test_CalculatePrice_ReturnsPriceOfBookInBasket_WhenPassedBasketWithTenBooks() 
	{
		...
		//minus 13%: 10%+3%
		assertEquals(47.42, checkOut.calculatePrice(testBasket).doubleValue(), 0);
	}
