...
<html>
	...
	<body>
		...
		<%ArrayList<Issue> list=(ArrayList<Issue>)request.getAttribute("basicIssueList");%>
		
		<div id="navbar">
			<div id="navtab">
				<a id="navbutton1" href="<%=request.getContextPath()%>/viewissues">User Issues</a>
			</div>
		...
		<div id="tableBorder">
			<Table>
				...
				<tr>
					...
					<td><a id="lostPassword" href="<%=request.getContextPath()%>/updateissue?issueId=<%=issueList.getIssueId()%>">Update</a></td>
				</tr>
				<%} %>
			</Table>
