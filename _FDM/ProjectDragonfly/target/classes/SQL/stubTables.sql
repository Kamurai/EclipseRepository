...
VALUES( 'Need Unobtainium', 'I do not have enough unobtainium', 2, 0, 1, to_date('19-09-2017 09:00:00', 'dd-mm-yyyy hh24:mi:ss')  );
INSERT INTO ISSUES(TITLE, USERDESCRIPTION, SUBMITTEDBY, STATUSID, PRIORITY, DATESUBMITTED) 
VALUES( 'Broke desk chair', 'My desk chair is broken', 3, 0, 1, to_date('19-09-2017 10:00:00', 'dd-mm-yyyy hh24:mi:ss')  );
COMMIT;
