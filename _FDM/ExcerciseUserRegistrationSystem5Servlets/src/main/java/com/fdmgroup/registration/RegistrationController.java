...
public class RegistrationController {
	...
	public void registerNewUser(String username, String firstname, String lastname, String email, String password) throws UserNotWrittenException, UserNotReadException, UsernameIsTakenException 
	{
		//if the username is not taken
		if (readCommand.readUser(username) == null) 
		{
			User newUser = factory.createUser(username, firstname, lastname, email, password);
