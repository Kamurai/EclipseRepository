...
public class HighlightExample2 
{
	...
	public static Highlighter highlighter = new HighLighter(null);
}
...
class WordSearcher 
{
	...
	{
		this.comp = comp;
		this.painter = new HighLighter.Underliner(Color.red);
	}
	...
	public int search(String word) 
	{
		...
		for (int i = 0; i < highlights.length; i++) 
		{
			...
			if (h.getPainter() instanceof HighLighter.Underliner) 
			{
