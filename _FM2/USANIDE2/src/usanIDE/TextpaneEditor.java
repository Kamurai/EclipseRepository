...
public class TextpaneEditor 
{
	private JTextPane targetPane = new JTextPane();
	private Color masterColor = Color.black;
	
	public BoldAction boldAction;
	public ItalicAction italicAction;
	...
	public TextpaneEditor() 
	{
		...
		colorAction = new ColorAction(Color.black);
		colorAction.putValue(Action.NAME, "Color");
				
		foregroundAction = new ForegroundAction();
		foregroundAction.putValue(Action.NAME, "Color");
				
		formatTextAction = new FontAndSizeAction();
	...
	{
		return masterColor.toString();
	}
	
	public void setRange(int start, int end)
	{
		colorAction.setRange(start, end);
	}
	
	public void setPane(JTextPane input)
	{
		colorAction.setPane(input);
	}
...
class ColorAction extends StyledEditorKit.StyledTextAction 
{
	...
	public ColorAction(Color input) 
	{
		super("foreground");
		setColor(input);
	}
	...
	public void actionPerformed(ActionEvent e) 
	{
		JTextPane editor = getTargetPane();//(JTextPane) getEditor(e);
/*
		if (editor == null) 
		{
		...
		if (!cancelled) 
		{
			...
			if (editor != null) 
			{
				if (fg != null && !noChange) 
				{
					attr = new SimpleAttributeSet();
					StyleConstants.setForeground(attr, fg);
					setCharacterAttributes(editor, attr, false); //pivot!!!
				}
			}
		}// end if color != null
		noChange = false;
