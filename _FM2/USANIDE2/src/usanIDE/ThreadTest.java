...
public class ThreadTest extends Thread
{
	...
	public ThreadTest(String content, ArrayList<ArrayList<String>> keyWords, String commentColor)
	{
		Pikachu = new Seeker3();
	...
	public ThreadTest(String content, ArrayList<ArrayList<String>> keyWords, String commentColor, JTextPane textpane, JScrollPane scrollpane)
	{
		Pikachu = new Seeker3();
		Rhydon = new USANCompiler();
	...
	public ThreadTest(String content, ArrayList<ArrayList<String>> keyWords, String commentColor, JTextPane textpane, JScrollPane scrollpane, JTextPane outpane)
	{
